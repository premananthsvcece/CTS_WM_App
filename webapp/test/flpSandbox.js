		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Work Manager Dashbaord",
									"targetURL": "#sapppwcarewmdworkmanagerapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapppwcarewmdworkmanagerapp-display": {
								"semanticObject": "sapppwcarewmdworkmanagerapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.pp.wcare.wmd.workmanagerapp",
									"url": sap.ui.require.toUrl("sap/pp/wcare/wmd/workmanagerapp")
								}
							}
						}
					}
